...
class MinkUNetBackbone_directAdaIN_crossAttention_D1(BaseModule):
    ...
    def forward(self, voxel_features: Tensor, coors: Tensor) -> Tensor:
        ...
        if self.sparseconv_backend == 'spconv':
            ...
            return decoder_outs[-1].F, voxel_features, coors
            # if self.training and self.use_target:
            #     return decoder_outs[-1].F, voxel_features, coors#, rain_voxel_features, rain_coors
