...
metainfo_semanticstf = dict(
    classes=class_names, seg_label_mapping=labels_map_semanticstf, max_label=259)
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='semanticstf_infos_val_dense_fog.pkl',
        pipeline=test_pipeline,
        metainfo=metainfo_semanticstf,
        modality=input_modality,
        ignore_index=19,
        test_mode=True,
        backend_args=backend_args))
